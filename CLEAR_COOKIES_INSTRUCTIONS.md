...
1. Open the app: https://health-matchmaker-1.preview.emergentagent.com
2. Press F12 to open Developer Tools
3. Go to "Application" tab (Chrome) or "Storage" tab (Firefox)
4. On the left, expand "Cookies"
5. Click on "https://health-matchmaker-1.preview.emergentagent.com"
...
3. Output from: https://health-matchmaker-1.preview.emergentagent.com/api/auth/debug
